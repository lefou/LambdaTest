...
<dependencies>
  ...
  <!-- If you use LambdaTest with Jupiter / Junit5 -->
  <dependency>
...
== Choose your favorite Unit-Test Runner: TestNG, JUnit, Jupiter (JUnit5)
...
For Jupiter (JUnit5) you inherit link:{srcdir}de/tobiasroeser/lambdatest/jupiter/FreeSpec{javasuffix}[`de.tobiasroeser.lambdatest.jupiter.FreeSpec`].
...
// You can also use JUnit or Jupiter based tests with
// import de.tobiasroeser.lambdatest.junit.FreeSpec;
// import de.tobiasroeser.lambdatest.junpiter.FreeSpec;
