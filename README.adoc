...
:lambdatestversion: 0.6.3
:documentationversion: 0.6.3
:testngversion: 6.11
:junitversion: 4.12
...
=== Analyze Double with `ExpectDouble`

To inspect and assert doupble, use the class `ExpectMap`, which is also returned, if you use `Expect.expectDouble`.
